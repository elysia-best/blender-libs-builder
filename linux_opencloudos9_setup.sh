...
# Modified to use OpenCloudOS 9 on LoongArch64 by Elysia
...
# NOTE: However we only have gcc12 on loongarch
yum -y groupinstall "Development Tools"

# TODO: LoongArch64 does not have CUDA support! 
...
PACKAGES_FOR_LIBS=(
    ...
    # TODO: LoongArch64 dose not have cuda
    # cuda-toolkit-12-8
...
wget -k -q -O /tmp/rocm-6.3.1-loongarch64.tar.gz https://github.com/loong64-abi2-0/ROCm-Binary/releases/download/v6.3.1/rocm-6.3.1-loongarch64.tar.zst
